...
$Global:DscHelper = New-M365DscUnitTestHelper -StubModule $CmdletModule `
    -DscResource "IntuneDeviceManagementNotificationMessageTemplate" -GenericStubModule $GenericStubPath
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        # Test contexts
        Context -Name "The IntuneDeviceManagementNotificationMessageTemplate should exist but it DOES NOT" -Fixture {
            BeforeAll {
                $testParams = @{
                    BrandingOptions = "none"
                    DefaultLocale = "FakeStringValue"
        ...
        Context -Name "The IntuneDeviceManagementNotificationMessageTemplate exists but it SHOULD NOT" -Fixture {
            BeforeAll {
                $testParams = @{
                    BrandingOptions = "none"
                    DefaultLocale = "FakeStringValue"
        ...
        Context -Name "The IntuneDeviceManagementNotificationMessageTemplate Exists and Values are already in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    BrandingOptions = "none"
                    DefaultLocale = "FakeStringValue"
        ...
        Context -Name "The IntuneDeviceManagementNotificationMessageTemplate exists and values are NOT in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    BrandingOptions = "none"
                    DefaultLocale = "FakeStringValue"
